...
const config = {
    ...
    scene: [
        Bootloader,Scene_login,Scene_registro,Scene_loginProfesor,Scene_mapa,Scene_detallesCat ,Scene_temas,Scene_nivel1,Scene_restas, Scene_divisiones,Scene_rancking,Scene_grupos,Scene_agregarGrupo
    ]
};
