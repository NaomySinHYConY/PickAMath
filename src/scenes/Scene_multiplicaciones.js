class Scene_multiplicaciones extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(['fondo_multi', 'titulo4', 'tituloPAM', 'IntentosCuadro', 'EliminaEnemigos', 'cookie', 
        'speech', 'btnResp', 'Intentos', 'planet4', 'next2']);
    ...
    create() {
        ...
        this.titulo = this.add.image(500, 30, 'titulo4').setScale(0.25);
        this.tituloPAM = this.add.image(500, 58, 'tituloPAM').setScale(0.65);
        this.planet = this.add.image(0, 485, 'planet4').setOrigin(0).setScale(0.8);
