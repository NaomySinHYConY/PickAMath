class Scene_nivel6 extends Phaser.Scene{
    constructor(){
        super({
            key: "Scene_nivel6" //Nombre interno o clave de referencia
        });
    }
    init(code) {
    ...
    preload(){
        this.load.path = "./assets/nivel6/"; //Ruta de las imgs
        this.load.image(["drop", "p0", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10", "p11", "p12", "p13", "p14", "p15", "p16", "p17", "p18", "p19", "fondoR6", "fondoWi", "titulo6", "tituloPAM", "planet6"]); //Arreglo de imagenes
    ...
    addDataGen(eventos){
        this.fondo = this.add.image(0, 0, "fondoR6");
        this.fondo.setOrigin(0);
        //this.fondo.setScale(1);
        this.titulo = this.add.image(500, 40, 'titulo6').setScale(0.3);
        ...
        this.planet = this.add.image(0, 485, 'planet6').setOrigin(0);
