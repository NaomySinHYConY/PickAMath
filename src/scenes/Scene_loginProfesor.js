class Scene_loginProfesor extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('astro_foto','astro_foto.png');
    ...
    create() {
        ...
        this.loginform = this.add.dom(500, 500).createFromCache('loginform');
        this.loginform.setDepth(5);
        //this.astro_foto     = this.add.image(500,100,"astro_foto").setDepth(6).setScale(0.50);
        /*
